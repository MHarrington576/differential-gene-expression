...
#Sort the columns in the FPM data frame
  conditionA = which(annotation[2] == "ea_bc_gem")
  conditionB = which(annotation[2] == "aa_bc_gem")
  norm = subset(norm, select=c(conditionA, conditionB))
  print(str(norm))
#Retrieve the results
  res <- results(dds, contrast=c("Group", "ea_bc_gem", "aa_bc_gem"))
  print(summary(res))
...
main('final-merged-bc-gem.csv', 'merged-bc-gem.comparison.csv', 'output-bc-gem-deg.csv')
