...
deseq_results <- read_csv("output-bc-gem-deg.csv")
...
volcano_plot <- ggplot(deseq_results, aes(x = log2FoldChange, y = -log10(padj), 
  ...
  labs(
    title = "Differential Gene Expression in AA vs. EA Breast Cancer",
    subtitle = "AA vs. EA TCGA samples",
    x = "Log2 Fold Change",
...
ggsave("aa-vs-ea-bc-deg-plot.png", volcano_plot, width = 10, height = 8, dpi = 300)
